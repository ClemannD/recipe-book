    ...
    recipe && (
      <>
        <div className="absolute right-0 top-0 p-4 pb-12">
          {onFullscreenClick && (
            <button
              className="hidden rounded-full border bg-white p-2 transition-colors ease-in-out hover:bg-gray-200 lg:block"
        ...
        <div className="absolute left-0 top-0 p-4">
          <button
            className="rounded-full border bg-white p-2 transition-colors ease-in-out hover:bg-gray-200"
            onClick={() => onClose()}
          >
            <X></X>
          </button>
